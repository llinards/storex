    ...
    <ul class="flex justify-center border-t-1 border-storex-grey pb-4 pt-8 text-center sm:border-none sm:pt-0"
        ...
        <li class="mx-4">
            <button id="agriculture-tab" data-tabs-target="#agriculture" type="button" role="tab"
                aria-controls="agriculture" aria-selected="true"
        ...
        <div class="hidden px-4 lg:px-6 xl:px-8" id="agriculture" role="tabpanel" aria-labelledby="agriculture-tab">
            <div class="items-center gap-2 py-2 text-center sm:gap-6 sm:py-4 md:flex md:text-left">
                ...
                <div>
                    ...
                    <p>
                        @lang('Uzņēmumi iegādājas mūsu angārus koksnes uzglabāšanai, izstrādājumu, preču un tehnikas
            ...
            <div class="items-center gap-2 py-2 text-center sm:gap-6 sm:py-4 md:flex md:text-left">
                ...
                <div>
                    ...
                    <p>
                        @lang('Angāriem, kas ir mazāki par 340 m2 nav nepieciešami īpaši pamati, un tos var uzstādīt
                        praktiski
            ...
            <div class="items-center gap-2 py-2 text-center sm:gap-6 sm:py-4 md:flex md:text-left">
                ...
                <div>
                    ...
                    <p>
                        @lang('Vairākas pašvaldības un iestādes ir jau iegādājušās mūsu angārus un izmanto tos kā tirgus
                        vai
                        izstāžu paviljonus.')
                    </p>
                </div>
