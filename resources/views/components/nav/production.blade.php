...
{{-- MOBILE VIEW --}}
<li class="pb-2 sm:relative sm:hidden border-b-1 px-4">
    <button id="production-mob-btn"
        class="inline-flex items-center pb-1 border-b-2 border-transparent transition duration-200" type="button">
        <svg id="arrow-mob-svg" class="sm:hidden icon mr-1 h-3 w-3 transition duration-200" aria-hidden="true"
    ...
    <div id="production-mob-content"
        ...
        <ul class="w-full sm:w-60 sm:px-3 sm:py-2 text-left text-sm sm:mt-0 sm:bg-white sm:shadow"
            aria-labelledby="production-mob-btn">
            {{ $slot }}
        </ul>
    </div>
</li>