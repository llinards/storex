<li class="py-1 sm:py-0">
    <button id="production-btn" data-dropdown-toggle="production-hover" data-dropdown-delay="200"
        data-dropdown-trigger="hover"
        class="inline-flex items-center border-b-2 border-transparent transition duration-200 hover:border-storex-red hover:text-storex-red"
        type="button">
        @lang('Produkcija')
