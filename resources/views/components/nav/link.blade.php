...
<li class="text-nowrap py-2 sm:py-0 flex items-center">
    @props(['active' => false])
    ...
    <a class="{{ $active ? ' text-storex-red' : '' }} border-b-2 border-transparent py-1 text-center transition duration-200 hover:border-storex-red hover:text-storex-red"
