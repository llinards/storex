    ...
    <div id="carousel-indicator" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item px-5">
                ...
                <h3>@lang('Ātra un ērta piegāde')</h3>
                <p>
                    @lang('Nodrošinām ātru piegādi un ātru piekļuvi mūsu produkcijai, pateicoties plašiem preču
                    krājumiem,
            ...
            <div class="carousel-item px-5">
                ...
                <h3>@lang('Uzticamība')</h3>
                <p>
                    @lang('Piedāvājam 100% servisu, kas ietver ne tikai profesionālas konsultācijas pirms iegādes, bet
                    arī
