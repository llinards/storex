<x-faq.question>
    ...
    <x-slot name="answer">
        @lang('3 gadu standarta garantija, garantija nestrādā uz mehāniskiem bojājumiem.')
    </x-slot>
</x-faq.question>
...
<x-faq.question>
    ...
    <x-slot name="answer">
        @lang('ALASKA-S - 2,3м. NORDA – 4,1м. EURO – 3,5м. VEGA – 3,2м.')
    </x-slot>
</x-faq.question>
...
<x-faq.question>
    ...
    <x-slot name="answer">
        @lang('Angārus ir iespējams savienot kopā tikai ar galiem.')
    </x-slot>
</x-faq.question>
...
<x-faq.question>
    ...
    <x-slot name="answer">
        @lang('Jā, tas ir iespējams, bet standarta komplektācijā tādu vārtu nav.')
    </x-slot>
</x-faq.question>
