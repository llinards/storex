    ...
    <div>
        ...
        <div>
            <ul>
                <li class="grid grid-flow-col items-center justify-start pb-2">
                    <svg class="icon mr-1 h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 10 16">
                        <path
        ...
        <div>
            ...
            <x-btn href="#contact-us" class="scroll-btn my-2 flex items-center justify-center sm:justify-start">
                @lang('Pasūtīt')
                <svg class="ml-4" xmlns="http://www.w3.org/2000/svg" width="36" height="28" fill="#ffffff"
                    viewBox="0 0 256 256">
                    <path
        ...
        <div class="pt-2">
            <ul class="gap-2 sm:flex md:gap-6 lg:gap-8">
                ...
                <li
                    ...
                    <p class="pt-2 sm:pb-2 md:pb-0 sm:text-xs">
