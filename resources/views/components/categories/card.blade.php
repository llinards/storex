<div class="carousel-cell relative">
    <a {{ $attributes->merge(['aria-label' => 'Clickable image linking to category of products']) }}
        class="relative block h-56 overflow-hidden focus:outline-none focus:ring-2 focus:ring-storex-red lg:h-64"
        >
        <img class="h-full w-full rounded-t-lg object-cover" src="{{ $image ?? '' }}"
            ...
            <div class="category-details flex-grow">
                ...
                <div class="flex items-center pb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="me-2 flex-shrink-0" width="20" height="20"
                        fill="#353535" viewBox="0 0 256 256" aria-hidden="true">
                        <path
    ...
    <a class="flex justify-center rounded-b-lg bg-storex-red py-2 font-bold text-white shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-storex-red sm:shadow-none sm:hover:shadow-md"
        {{ $attributes }} aria-label="@lang('Skatīt kategorijas')">
        {{ $link }}
    </a>
</div>